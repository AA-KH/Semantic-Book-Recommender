...
with gr.Blocks(theme = gr.themes.Ocean()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(label="Describe what kind of book you want", placeholder="e.g. I want a lighthearted romance novel set in Paris")
        category_dropdown = gr.Dropdown(choices=categories, value="All", label="Category")
        tone_dropdown = gr.Dropdown(choices=tones, value="All", label="Tone")
